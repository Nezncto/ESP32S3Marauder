#pragma once
  ...
  //// HARDWARE NAMES
    ...
    #define HARDWARE_NAME "ESP32-S3 Mini"
  #else
 ...
 //// BOARD FEATURES
  ...
  //// DISPLAY DEFINITIONS
      ...
      #define STANDARD_FONT_CHAR_LIMIT (TFT_HEIGHT/6) // number of characters on a single line with normal font
      #define TEXT_HEIGHT 14 // Height of text to be printed and scrolled
      #define BOT_FIXED_AREA 0 // Number of lines in bottom fixed area (lines counted from bottom of screen)
      #define TOP_FIXED_AREA 48 // Number of lines in top fixed area (lines counted from top of screen)
      #define YMAX 170 // Bottom of screen area
      ...
      #define minimum(a,b)     (((a) < (b)) ? (a) : (b))
      //#define MENU_FONT NULL
      #define MENU_FONT &FreeMono12pt7b // Winner FreeMono12pt7b
      //#define MENU_FONT &FreeMonoBold9pt7b
      //#define MENU_FONT &FreeSans9pt7b
      //#define MENU_FONT &FreeSansBold9pt7b
